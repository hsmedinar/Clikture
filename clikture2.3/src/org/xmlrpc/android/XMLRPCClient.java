...
// reader = new StringReader("<?xml version='1.0'?><methodResponse><params><param><value>\n\n\n</value></param></params></methodResponse>");
        ...
        public String testtt(String xml) throws XMLRPCException {
            try {
                    // prepare POST body
                    						...
                    						"<methodName>node.save</methodName>"+
                    							"<params>"+
                    							 ...
                    							 "<param>"+
                    							 	...
                    							 	"<value><string>android-imagen.jpg</string></value>"+
                    							 	"</member>"+
                    							 	"</struct></value>"+
                    							 	"</data>"+
                    							 	"</array></value>"+
                    							 	...
                    							 	"<value><struct>"+
                    							 	"<member><name>value</name>"+
                    							 	"<value><string>08 OCT, 2011</string></value>"+
                    							 	"</member>"+
                    							 	"</struct></value>"+
                    							 	"</data>"+
                    							 	"</array></value>"+
					...
					*/
                    ...
                    //Log.d(Tag.LOG, "ros status code:" + statusCode);
                    if (statusCode != HttpStatus.SC_OK) {
                    	 //throw new XMLRPCException(body);
                            throw new XMLRPCException("HTTP status code: " + statusCode + " != " + HttpStatus.SC_OK);
                    }
...
//reader = new StringReader("<?xml version='1.0'?><methodResponse><params><param><value>\n\n\n</value></param></params></methodResponse>");
        ...
        public String test(String method, Object[] params) throws XMLRPCException {
            try {
                    // prepare POST body
                    String body = methodCall(method, params);
